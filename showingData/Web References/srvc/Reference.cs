...
namespace showingData.srvc {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="maServiceSoap", Namespace="http://tempuri.org/")]
    public partial class maService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public maService() {
            this.Url = global::showingData.Properties.Settings.Default.showingData_srvc_maService;
        ...
        /// <remarks/>
        public void rechercheAsync(string name) {
            this.rechercheAsync(name, null);
        }
        
        /// <remarks/>
        public void rechercheAsync(string name, object userState) {
            ...
            this.InvokeAsync("recherche", new object[] {
                        name}, this.rechercheOperationCompleted, userState);
        }
